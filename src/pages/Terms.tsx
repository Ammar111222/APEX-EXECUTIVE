...
const Terms = () => {
  return (
    <>
      <Helmet>
        <title>Terms of Service | Apex Executive Partners</title>
      </Helmet>
      ...
      >
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex items-center justify-between mb-4">
            <h1 className="text-2xl md:text-3xl font-bold text-royal-gold">Terms of Service</h1>
            <a
              href={encodeURI('/Terms of Service for Apex Executive Partners.pdf')}
              download
          ...
          <div className="rounded-lg border border-royal-gold/30 overflow-hidden shadow-lg bg-deep-charcoal">
            <iframe
              ...
              src={encodeURI('/Terms of Service for Apex Executive Partners.pdf')}
              className="w-full"
              style={{ height: "80vh" }}
            />
          </div>
